      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row items-center">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-12 py-16 lg:py-0">
          <div className="max-w-3xl text-center lg:text-left">
            <div>
              <p
                className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-medium text-white/90 mb-6 backdrop-blur-sm"
              >
                {serviceName} in {areaLabel}
              </p>

              <h1
                ref={titleRef}
                className={`text-2xl sm:text-3xl md:text-4xl font-bold mb-6 tracking-tight transition-all duration-700 ${
              ...
              {subheading && (
                <h2
                  ref={subtitleRef}
                  className={`text-xl sm:text-2xl mb-6 text-white/80 transition-all duration-700 delay-100 ${
