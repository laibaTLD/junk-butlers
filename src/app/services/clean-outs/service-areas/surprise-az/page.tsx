...
export const metadata: Metadata = {
  title: 'Expert Junk & Trash Clean Out Services in Surprise AZ | Junks Butlers',
  description: 'Junks Butlers provides expert trash clean out services in Surprise, AZ. We offer same-day junk removal, demolition contractor services, and residential or commercial trash clean outs.',
  alternates: {
    canonical: 'https://junksbutlers.com/services/clean-outs/service-areas/surprise-az',
  },
  robots: {
    index: true,
    follow: true,
