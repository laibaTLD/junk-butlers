...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://junksbutlers.com/services/trash-removal',
  },
  robots: {
    index: true,
    follow: true,
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• <Link href="/services/trash-removal/service-areas/peoria-az" className="text-blue-600 hover:text-blue-800 hover:underline">Peoria, AZ</Link></li>
                    <li>• <Link href="/services/trash-removal/service-areas/phoenix-az" className="text-blue-600 hover:text-blue-800 hover:underline">Phoenix, AZ</Link></li>
                    <li>• <Link href="/services/trash-removal/service-areas/glendale-az" className="text-blue-600 hover:text-blue-800 hover:underline">Glendale, AZ</Link></li>
                    <li>• <Link href="/services/trash-removal/service-areas/sun-city-az" className="text-blue-600 hover:text-blue-800 hover:underline">Sun City, AZ</Link></li>
                    <li>• <Link href="/services/trash-removal/service-areas/surprise-az" className="text-blue-600 hover:text-blue-800 hover:underline">Surprise, AZ</Link></li>
                    <li>• <Link href="/services/trash-removal/service-areas/scottsdale-az" className="text-blue-600 hover:text-blue-800 hover:underline">Scottsdale, AZ</Link></li>
                  </ul>
                </div>
              </div>
