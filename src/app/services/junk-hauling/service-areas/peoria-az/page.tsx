...
export const metadata: Metadata = {
  title: 'Professional Junk Hauling Services in Peoria AZ | Junks Butlers',
  description: 'Looking for a reliable junk hauling service in Peoria, AZ? Junks Butlers offers professional and affordable junk removal services. Contact us today for a free quote!',
  alternates: {
    canonical: 'https://junksbutlers.com/services/junk-hauling/service-areas/peoria-az',
  },
  robots: {
    index: true,
    follow: true,
