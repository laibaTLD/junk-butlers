...
export const metadata: Metadata = {
  title: 'Professional Junk Hauling Services in Sun City AZ | Fast & Affordable',
  description: 'Junks Butlers offers reliable junk hauling services in Sun City, AZ. We provide efficient removal of furniture, appliances, and household junk with same-day service available. Call for a free estimate!',
  alternates: {
    canonical: 'https://junksbutlers.com/services/junk-hauling/service-areas/sun-city-az',
  },
  robots: {
    index: true,
    follow: true,
